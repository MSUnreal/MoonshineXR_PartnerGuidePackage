...
3. Inside World Outliner, attach the Cine Camera Actor to BP_StudioA_Previs actor. Select the target camera in Details Panel. ![image](https://github.com/MSUnreal/MoonshineXR_PartnerGuidePackage/blob/5.3/_Attachments/Img_MSXRPluiginUserGuide_011.png?raw=true)
...
![image](https://github.com/MSUnreal/MoonshineXR_PartnerGuidePackage/blob/5.3/_Attachments/Img_MSXRPluiginUserGuide_013.png?raw=true)
...
![image](https://github.com/MSUnreal/MoonshineXR_PartnerGuidePackage/blob/5.3/_Attachments/Img_MSXRPluiginUserGuide_016_en.png?raw=true)
![image](https://github.com/MSUnreal/MoonshineXR_PartnerGuidePackage/blob/5.3/_Attachments/Img_MSXRPluiginUserGuide_017_en.png?raw=true)
...
![image](https://github.com/MSUnreal/MoonshineXR_PartnerGuidePackage/blob/5.3/_Attachments/Img_MSXRPluiginUserGuide_020_en.png?raw=true)
